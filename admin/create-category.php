    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          ...
          <form method="post" action="../db/added-category.php" enctype="multipart/form-data">
            <div>
              <div class="col-6 my-3">
                <label for="txtname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category
                  Name</label>
                <input type="text" name="txtname" id="name" class="form-control" placeholder="Type product name"
                  required="" />
              </div>
