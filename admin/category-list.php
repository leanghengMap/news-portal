                ...
                if (
                  ...
                  while ($row = mysqli_fetch_array($result)) { ?>
                    <tr class="hover:bg-gray-50">
                      ...
                      <td>
                        <!-- <?php echo nl2br($row['category_description']); ?> -->
                      ...
                      <td>
                        <div class="d-flex align-items-center justify-content-between ">
                          <a x-data="{ tooltip: 'Delete' }"
                            href="../db/delete-category.php?category_id=<?php echo $row['category_id']; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          ...
                          <a x-data="{ tooltip: 'Edit' }"
                            href="../admin/edit-category.php?category_id=<?php echo $row['category_id']; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
