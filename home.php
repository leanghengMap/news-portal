    ...
    <nav class="container navbar navbar-expand-lg "
      ...
      <div class="container p-0">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto mb-lg-0 d-flex justify-content-end gap-4"
          ...
          <div class="container-fluid py-2 text-center text-md-start mt-5" style="padding: 0px 70px;">
            <div class="row mt-5">
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p><i class="fas fa-home me-3 text-secondary"></i> Phnom Penh, Cambodia</p>
                <p>
                  <i class="fas fa-envelope me-3 text-secondary"></i>
                  nuteam@email.com
                </p>
                <p><i class="fas fa-phone me-3 text-secondary"></i> + 855 16 20 36 16 </p>
                <p><i class="fas fa-print me-3 text-secondary"></i> + 855 76 60 60 800</p>
              </div>
            </div>
          </div>
        </section>
